...
<p class='mb-3'>
    The default font is <a class='pink' href='https://fonts.google.com/specimen/Open+Sans' target='_blank'>Google Fonts Open Sans</a>
</p>

Default size is `14px` and the default color is `black #31353B`
